...
import { ChevronDown, Download, Eye, EyeOff, Loader2, RefreshCw } from 'lucide-react';
import {
  TranslationEvents,
...
/**
 * Providers exposed in the settings dropdown. `tesseract-only` is OCR-only and
 * never selectable as a default translation backend — keep the union closed
 * here so the dropdown matches the runtime registry.
 */
...
type DisplayProviderId = (typeof PROVIDER_OPTIONS)[number]['value'];
  ...
  return (
    <div className="relative">
      <select
        ...
        data-testid="translation-default-provider"
  ...
  return (
    <div className="inline-flex items-center gap-3">
      <input
        ...
        disabled={disabled}
        aria-label={ariaLabel}
        data-testid="translation-overlay-opacity"
