...
export const pl = {
  ...
  'chapterList.downloadAll.label': 'Pobierz wszystkie',
  'chapterList.downloadAll.count': 'Pobierz wszystkie · {count}',
  'chapterList.downloadAll.aria': 'Pobierz wszystkie niepobrane rozdziały',
  'chapterList.downloadAll.disabledAria': 'Wszystkie rozdziały są już pobrane',
  'chapterList.downloadAll.confirm.eyebrow': 'Kolejkuj pobieranie',
  'chapterList.downloadAll.confirm.title': 'Pobrać {count} rozdziałów?',
  'chapterList.downloadAll.confirm.body':
    'Strony zostaną zapisane w pamięci podręcznej, a kolejka działa w tle — możesz dalej przeglądać.',
  'chapterList.downloadAll.confirm.confirm': 'Dodaj do kolejki',
  'chapterList.downloadAll.confirm.cancel': 'Anuluj',
  'chapterList.downloadAll.toastTitle': 'Dodano do kolejki',
  'chapterList.downloadAll.toastBody': 'Dodano {count} rozdziałów.',
  'chapterList.downloadAll.toastBody_one': 'Dodano 1 rozdział.',
  'chapterList.downloadAll.toastBody_few': 'Dodano {count} rozdziały.',
  'chapterList.downloadAll.toastBody_many': 'Dodano {count} rozdziałów.',
  'chapterList.downloadAll.toastBody_other': 'Dodano {count} rozdziałów.',
